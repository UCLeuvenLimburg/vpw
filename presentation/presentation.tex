...
\setbeamertemplate{title page}{%
  \begin{center}
    ...
    {\sc\huge \inserttitle}\\[5mm]
    Slides beschikbaar op \\
    \link{http://files.leone.ucll.be/vpw/}{http://files.leone.ucll.be/vpw/}
  \end{center}
}
...
\begin{frame}
  ...
  \begin{center}
    \begin{tikzpicture}[team member/.style={},
      ...
      \node[team member,anchor=south] (rick) at (0,0) {\includegraphics[height=1cm]{rick.jpg}};
      \node[team member,anchor=south east] at ($ (rick.south west) + (-0.5,0) $) {\includegraphics[height=1cm]{morty.jpg}};
      \node[team member,anchor=south west] at ($ (rick.south east) + (0.5,0) $) {\includegraphics[height=1cm]{summer.jpg}};
      \node[fill=blue!25,font=\Large,anchor=north,minimum width=5cm] at (rick.south) {\sc drie teamleden};

      \node[anchor=south] (laptop) at (0,-2.5) {\includegraphics[height=1cm]{laptop.jpg}};
      \node[anchor=north,fill=blue!25,font=\Large,minimum width=5cm] at (laptop.south){\sc \'e\'en laptop};

      \node[riddle,anchor=south] (riddle) at (0,-5) {\includegraphics[height=1cm]{riddle.jpg}};
      \node[riddle,anchor=south] at (-1,-5) {\includegraphics[height=1cm]{riddle.jpg}};
      \node[riddle,anchor=south] at (-2,-5) {\includegraphics[height=1cm]{riddle.jpg}};
      \node[riddle,anchor=south] at (1,-5) {\includegraphics[height=1cm]{riddle.jpg}};
      \node[riddle,anchor=south] at (2,-5) {\includegraphics[height=1cm]{riddle.jpg}};
      ...
      \begin{scope}[rotate=-20,transform shape,xshift=5cm]
        \node (time) {\includegraphics[height=1cm]{hourglass.jpg}};
  ...
  \begin{itemize}
    \item Algoritmisch van aard
          \begin{itemize}
            ...
            \item Ook beschikbaar op \link{https://github.com/UCLeuvenLimburg/VPW-opgaves}{GitHub}
          \end{itemize}
...
\begin{frame}
  ...
  \begin{center}
    \begin{tikzpicture}
      \path[use as bounding box] (0,0) rectangle (3, 5);
...
\begin{frame}
  ...
  \begin{center} \Large
    Nog onbekend \\ \small (\link{https://www.vlaamseprogrammeerwedstrijd.be/current/\#inschrijven}{inschrijvingspagina})
  \end{center}

  \structure{Wedstrijd}
  \begin{center} \Large
    4 april 2021, 13:00-18:30 \\[2mm]
